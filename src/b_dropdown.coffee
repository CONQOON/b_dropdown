  ...
  ($) ->
    class Dropdown
      ...
      constructor: (el, opts) ->
        ...
        @$mockEl = $ '<div class="bJS_dropdown b_dropdown"></div>'
        ...
        @$mockToggleHeader = @$mockEl.find '.bJS_dropdown-toggle'
      ...
      closeMock: () =>
        if not @isDisabled()
          @$mockEl.removeClass 'b_dropdown-open'
      ...
      openMock: () =>
        if not @isDisabled()
          @$mockEl.addClass 'b_dropdown-open'
